    ...
    <>
      ...
      <div className="app">
        ...
        <header className="hero">
          ...
          <p>
            Cut through the noise. Brevity synthesizes top stories across technology, finance, healthcare, energy, real estate, politics, and startups — delivered as a concise audio briefing and PDF before your first coffee.
          </p>
        ...
        <section className="howto-section" id="how-it-works">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p className="section-desc" style={{ margin: "0 auto" }}>
              Brevity is designed to get you informed in minutes, not hours. Here's how to make the most of it.
            </p>
          </div>
        ...
        <footer className="footer">
          <div className="footer-logo">
            <span className="logo-dot" /> Brevity
          </div>
          <p>Your daily intelligence brief — across every industry that matters.</p>
          <p style={{ marginTop: 8, fontSize: "0.78rem" }}>© 2026 Brevity. All rights reserved.</p>
        </footer>
      </div>
    </>
  );
