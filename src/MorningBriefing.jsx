...
const industries = [
  {
    ...
    stories: [
      ...
      { title: "Hyperscale AI Data Centers Push Infrastructure to Its Limits", tag: "Cloud", sub: "Cloud & Infrastructure", time: "5h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "The AI race has supercharged data centers into synchronized clusters working like giant supercomputers." },
  ...
  },
  {
    ...
    stories: [
      ...
      { title: "Oil Prices Surge Amid Iran Conflict, Complicating Rate Path", tag: "Oil", sub: "Commodities", time: "5h ago", url: "https://www.cnbc.com/2026/03/18/fed-interest-rate-decision-march-2026.html", source: "CNBC", summary: "Iran conflict drives gas prices to multi-year highs, threatening to reignite inflationary pressures." },
  ...
  },
  {
    ...
    stories: [
      { title: "Personalized Gene-Editing Treatment Advances to Clinical Trial", tag: "Genomics", sub: "Genomics", time: "2h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Baby KJ became the first to receive a personalized gene-editing treatment. A formal trial is now planned." },
      { title: "Extinct DNA Banks Yield Clues for New Medical Treatments", tag: "Genomics", sub: "Genomics", time: "4h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Growing banks of genetic info from extinct creatures are providing clues to new treatments." },
      { title: "AI Diagnostics Named Among 2026 Breakthrough Technologies", tag: "Digital", sub: "Digital Health", time: "5h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "AI-powered diagnostic tools have achieved specialist-level accuracy across multiple domains." },
      { title: "AI Chatbot Companion Risks Draw Policy Action", tag: "Policy", sub: "Health Policy", time: "6h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Mounting evidence of dangers from AI companion chatbots prompts regulatory action." },
      { title: "Embryo Screening Startups Make Bold Genetic Prediction Claims", tag: "Policy", sub: "Health Policy", time: "7h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "New startups claim they can predict traits including intelligence using genetic screening." },
  ...
  },
  {
    ...
    stories: [
      { title: "Sodium-Ion Batteries Emerge as Game-Changing Lithium Alternative", tag: "Storage", sub: "Grid & Storage", time: "1h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Made from abundant materials like salt, poised to power grids and affordable EVs worldwide." },
      { title: "Nuclear Renaissance: New Reactor Designs Promise Faster Deployment", tag: "Nuclear", sub: "Carbon Markets", time: "3h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Molten salt and TRISO fuel designs could accelerate zero-emission nuclear power deployment." },
      { title: "Oil Prices Surge on Middle East Conflict", tag: "Oil", sub: "Oil & Gas", time: "5h ago", url: "https://www.cnbc.com/2026/03/18/fed-interest-rate-decision-march-2026.html", source: "CNBC", summary: "Iran conflict drives gas prices to their highest level in years, complicating the energy transition." },
      ...
      { title: "AI Coding Tools Accelerate Clean Energy Software Development", tag: "Solar", sub: "Renewables", time: "7h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Rapid prototyping of grid management software and solar farm optimization is speeding deployment." },
  ...
  },
  {
    ...
    stories: [
      ...
      { title: "Data Center REITs Surge on AI Infrastructure Demand", tag: "REITs", sub: "REITs", time: "5h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Hyperscale AI data centers push REIT valuations higher with long-term premium leases." },
      { title: "AI Data Centers Reshape Commercial Real Estate Landscape", tag: "PropTech", sub: "PropTech", time: "6h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Convergence of AI demand, power constraints, and cooling needs creates a new asset class." },
    ],
  },
  {
    ...
    stories: [
      ...
      { title: "Iran Conflict Dominates Fed Policy and Global Market Outlook", tag: "Global", sub: "Global Affairs", time: "3h ago", url: "https://www.cnbc.com/2026/03/18/fed-interest-rate-decision-march-2026.html", source: "CNBC", summary: "War's impact on the Strait of Hormuz has roiled oil markets and complicated forecasting." },
  ...
  },
  {
    ...
    stories: [
      ...
      { title: "AI Coding Tools Lower Barriers for First-Time Founders", tag: "Seed", sub: "Seed & Series A", time: "6h ago", url: "https://www.technologyreview.com/2026/01/12/1130697/10-breakthrough-technologies-2026/", source: "MIT Tech Review", summary: "Record solo founders leveraging AI to build MVPs faster than ever before." },
